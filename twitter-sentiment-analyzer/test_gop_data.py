...
f = open('data/gop/august/NBClassifier','rb')
#f = open('data/gop/august/NBClassifier_no_stopwords','rb')
NBClassifier = pickle.load(f)
f.close()

f = open('data/gop/august/featureList','rb')
#f = open('data/gop/august/featureList_no_stopwords','rb')
